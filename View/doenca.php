...
<body style="background-color: PaleTurquoise">
    ...
    <div class="container">
        <div class="app">
            ...
            <div class="news">
                <div class="list">
                    <div class="item" style="border: 1px solid" onclick="location.href='doencaA.php'">
                    ...
                    <BR>
                    <div class="item" style="border: 1px solid" onclick="location.href='doencaB.php'">
                    ...
                    <div class="item" style="border: 1px solid" onclick="location.href='doencaC.php'">
